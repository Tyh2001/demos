var e = {
  version: '0.2.5',
  hostname: 'https://shoka.lostyu.me',
  root: '/',
  statics: '//cdn.jsdelivr.net/gh/amehime/shoka@86e5c71/',
  ...
  js: {
    ...
    fancybox:
      'combine/npm/jquery@3.5.1/dist/jquery.min.js,npm/@fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js,npm/justifiedGallery@3.8.1/dist/js/jquery.justifiedGallery.min.js'
  },
  css: {
    ...
    fancybox:
      'combine/npm/@fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css,npm/justifiedGallery@3.8.1/dist/css/justifiedGallery.min.css'
  },
  loader: { start: true, switch: true },
  search: {
    appID: '8AVSL3TE18',
    apiKey: '439b6e54d1a5364824e689b5ca5a55db',
    indexName: 'shoka',
    hits: { per_page: 10 }
  },
  valine: {
    appId: 'GfnpjP6kVt5Hwl5FDnWDCEX3-gzGzoHsz',
    appKey: '5VPzAxojlyJTTif1RMYNBBQy',
    placeholder: 'ヽ(○´∀`)ﾉ♪',
    avatar: 'mp',
    pageSize: 10,
    lang: 'zh-CN',
    ...
    tagMember: {
      master: ['deea5a8d259d17182a53be1772e4c182'],
      friend: [
        'b9102961b7749ccda0c5c6c1d9d42e03',
        'fc2c9b067f65c9e2d7057ba797f7cfca',
        '14983359e7df56a2055c6b47753a66f8',
        '8adafe8e74f58705cc6e0a1191e8c10b',
        '1b0478861d9d76d9ba9624a0883198f0',
        'd24719e3b7a66cbde951909bac991457',
        'e75d515c7d17eac575bf0e89d4461b40',
        'b90ed10c2395ddcfd33590a307ed3a4f',
        'b10e532f516ea1f464636a8be2ab6daf',
        '6bcf44de7033a4451f38d576fb6e6822',
        '9c1f881af8a4c0e5d84528aae6271c7d',
        'd03c1a5b7bed42f8bfecd084f359d2db',
        '6bcf44de7033a4451f38d576fb6e6822',
        '63888fafe3509785b63d09f1c44dc348',
        'f934bb2298b268a59bf72c7f52344105',
        '2a7765642415437fa16a54cd7f4442e2',
        'd5e6f626299d1cc2ebb6a8b28dfbe4f3',
        'f3517ae0315e5d5d5d99ea8c3415aff4',
        'bbca35300364b268662a56b05d130341',
        '406b2a0e1330c77fb4046e3ccd0a400e',
        '5e14d26e8ebbf5b28fe734b82043d3ad',
        '063d09d4cd137c27a94d0f74a9d26739',
        '41996231391a459b28151b7c35761331',
        'a234dd02f8f13336cd11d1c8fb96c523',
        '80a023e11167a78a35f72ef4dd0a48f4',
        'bc368ad8e4a86fd683eab52add960125',
        'f6905f36a6201fcbdb2fa7d56d2b92cc',
        '428bedbff8654564ca0e5a920ebed991',
        '7021c3626ea74a66f99a96eb37940cf2',
        '4f26ee22c61469795170c982b121e7c7',
        '73cbacc0496939ec16c0ceec0e94d327',
        'c6cceeba47fb1b565b8c6147abe7a96b',
        '7a3416cc7bb8e982dd0373670abf9ff5',
        '131ab989394372ace9fd15f9fc257a75',
        'd9b94d906bbd9770f25f73d3f2c4833c',
        '4f2d884013f126bf3ffe59ee2d9d7549',
        '055a933d93289954b5391d3ef19a0cca',
        'a4c17457638959bfc69cba5e05ef6f1a',
        'a4c17457638959bfc69cba5e05ef6f1a',
        '94e346824ff79d394373b917b01c84ed',
        'c70682ef9dcd779d4b27dda52a6e231e',
        'd34be06d97c4b5e57bd6fbbb84f19d28',
        'f70dd565082c736ce018e2c7a93d76da',
        'd29b9dcf032ce0396d93e95c2d3fde87',
        '776490af4e277b145f6b1d95e4579ae1',
        '1c7da72b872c914b431efdb6e8eeea9e',
        '9fb4a337cc4ebb0228e846650d3de2f3',
        '9815ed2dd83db30c0be588123dabacf6',
        '7393ce11f9eb873b79ac6a74c39f8eca',
        '2393fefeb8f2e4bcb3a25beb4a85ee07'
      ],
      investor: ['b6c145fb2ec70c331eba308ec32717f6']
    }
  },
  quicklink: { timeout: 3e3, priority: true },
  audio: [
    { title: '造语', list: ['https://music.163.com/#/playlist?id=2297706586'] },
    {
      title: '鸡血',
      list: [
  ...
  var n = {
    ...
    scrollTop:
      ...
      (typeof e == 'number'
        ? e
        : e
        ? e.top() + document.documentElement.scrollTop - R
        : 0),
    complete: function () {
      a && a()
    }
...
const l = function (e, t, a) {
  ...
  anime(
    Object.assign({ targets: e, duration: 200, easing: 'linear' }, n)
...
const p = function (e, t) {
  ...
  var r = {
    ...
    create: function () {
      if (this.el) return
      this.el = e.createChild(
        'div',
        {
          className: 'player-info',
          innerHTML:
            (e.player.options.type == 'audio'
    ...
    create: function () {
      ...
      this.data.map(function (a, n) {
        ...
        if (!c) {
          c = t.createChild('div', {
            id: r,
            className: e.player.group ? 'tab' : '',
            innerHTML: '<ol></ol>'
          })
          if (e.player.group) {
            c.attr(
              'data-title',
              e.player.options.rawList[a.group]['title']
            ).attr('data-id', e.player._id)
          }
        }
        a.el = c.child('ol').createChild('li', {
  ...
  var c = {
    ...
    create: function (e) {
      ...
      var i = function (n) {
        ...
        a.el = e.createChild(
          'div',
          { className: 'inner', innerHTML: i },
          'replace'
        )
        a.index = 0
      }
      if (n.startsWith('http')) this.fetch(n, i)
      else i(n)
    },
    update: function (e) {
      if (!this.data) return
      if (
        ...
        e < this.data[this.index][0] ||
        !this.data[this.index + 1] ||
        e >= this.data[this.index + 1][0]
      ) {
        for (var t = 0; t < this.data.length; t++) {
          if (
            e >= this.data[t][0] &&
            (!this.data[t + 1] || e < this.data[t + 1][0])
          ) {
            this.index = t
            var a = -(this.index - 1)
      ...
      if (e) {
        ...
        for (var i = 0; i < n; i++) {
          ...
          if (r) {
            const c = r.length
            for (var o = 0; o < c; o++) {
              const l = /\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/.exec(r[o])
              const d = l[1] * 60
              const u = parseInt(l[2])
              const f = l[4]
                ? parseInt(l[4]) / ((l[4] + '').length === 2 ? 100 : 1e3)
                : 0
              const h = d + u + f
              a.push([h, s])
            }
  ...
  var l = {
    ...
    create: function () {
      ...
      this.el
        .child('.cover')
        .addEventListener('click', e.player.options.events['play-pause'])
      c.create(this.el.child('.lrc'))
    }
  }
  var p = {
    el: null,
    ...
    create: function () {
      ...
      if (e) {
        if (this.el) {
          this.el.parentNode
            .removeClass('current')
            .removeEventListener(n.nameMap.dragStart, this.drag)
          this.el.remove()
        }
    ...
    seeking: function (e) {
      if (e) this.el.addClass('seeking')
      else this.el.removeClass('seeking')
    },
    percent: function (e, t) {
      var a =
        ((e.clientX || e.changedTouches[0].clientX) - t.left()) / t.width()
      a = Math.max(a, 0)
      return Math.min(a, 1)
    },
    drag: function (t) {
  ...
  var m = {
    ...
    update: function (e) {
      m.btns['volume'].className =
        'volume ' + (!i.muted && e > 0 ? 'on' : 'off') + ' btn'
  ...
  document.addEventListener('visibilitychange', function () {
    switch (document.visibilityState) {
      case 'hidden':
        ...
        if (e.loader.switch) V.show()
        clearTimeout(y)
        break
      case 'visible':
        u('[rel="icon"]').attr('href', m + e.favicon.normal)
        document.title = LOCAL.favicon.show
        if (e.loader.switch) V.hide(1e3)
...
const K = function (e) {
  ...
  N.toggleClass(
    'affix',
    window.pageYOffset > _ && document.body.offsetWidth > 991
  )
  ...
  v.y = window.pageYOffset
  var c = Math.round(Math.min((100 * window.pageYOffset) / i, 100)) + '%'
  H.child('span').innerText = c
  u('.percent').width(c)
}
const Z = function () {
...
const ie = function () {
  ...
  var r = function (e, n) {
    ...
    while (!s.matches('.contents')) {
      if (s.matches('li')) {
        s.addClass('active')
        var c = u(s.child('a.toc-link').attr('href'))
        if (c) {
          c.addClass('active')
        }
      }
    ...
    if (getComputedStyle(N).display != 'none' && i.hasClass('active')) {
      o(i, r.offsetTop - i.offsetHeight / 4)
    }
  }
  var s = function (e) {
    var t = 0
...
const oe = function () {
  u.each('.menu .item:not(.title)', function (t) {
    ...
    var i =
      ...
      a.pathname === location.pathname.replace('index.html', '')
    var r =
      !e.root.startsWith(a.pathname) && location.pathname.startsWith(a.pathname)
    var s = a.hostname === location.hostname && (i || r)
    t.toggleClass('active', s)
    if (t.parentNode.child('.active') && n.hasClass('dropdown')) {
      n.removeClass('active').addClass('expand')
    } else {
    ...
    r(
      ...
      function () {
        ...
        u.each(e + ' p.gallery', function (e) {
          var t = document.createElement('div')
          t.className = 'gallery'
          t.attr('data-height', e.attr('data-height') || 220)
...
const fe = function () {
  ...
  u.each('div.tags a', function (e) {
    e.className = ['primary', 'success', 'info', 'warning', 'danger'][
      Math.floor(Math.random() * 5)
    ]
  })
  u.each('.md div.player', function (e) {
    p(e, { type: e.attr('data-type'), mode: 'order', btns: [] })
      .player.load(JSON.parse(e.attr('data-src')))
      .fetch()
  })
}
const he = function () {
  ...
  u.each('div.tab', function (t, a) {
    ...
    var c = r.child('.nav ul')
    if (!c) {
      c = r
        .createChild('div', { className: 'nav', innerHTML: '<ul></ul>' })
        .child('ul')
    }
    var l = c.createChild('li', { innerHTML: i })
    if (e) {
      l.addClass('active')
      t.addClass('active')
    }
...
const me = function (t) {
  ...
  a.addWidgets([
    instantsearch.widgets.configure({
      hitsPerPage: e.search.hits.per_page || 10
    }),
    ...
    instantsearch.widgets.stats({
      ...
      templates: {
        text: function (e) {
          var t = LOCAL.search.stats
            .replace(/\$\{hits}/, e.nbHits)
            .replace(/\$\{time}/, e.processingTimeMS)
    ...
    instantsearch.widgets.hits({
      ...
      templates: {
        item: function (t) {
          var a = t.categories
            ? '<span>' +
              t.categories.join('<i class="ic i-angle-right"></i>') +
              '</span>'
            : ''
          return (
            '<a href="' +
...
const ve = function () {
  ...
  k.addEventListener('click', V.vanish)
...
const ye = function () {
  ...
  window.addEventListener('pjax:success', be)
  window.addEventListener('beforeunload', function () {
    Z()
  })
  be(1)
}
window.addEventListener('DOMContentLoaded', ye)
console.log(
  '%c Theme.Shoka v' + e.version + ' %c https://shoka.lostyu.me/ ',
